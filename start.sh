...
curl -o .local/start.sh https://raw.githubusercontent.com/bitcoin-sv/spv-wallet/master/start.sh
echo ""
echo "Downloading newest version of docker-compose.yml from bitcoin-sv/spv-wallet repository:"
curl -o .local/docker-compose.yml https://raw.githubusercontent.com/bitcoin-sv/spv-wallet/master/docker-compose.yml
